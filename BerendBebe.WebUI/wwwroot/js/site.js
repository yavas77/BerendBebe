...
$.AjaxCartAdd = function (url, model) {
    $.ajax(
        {
            type: "post",
            url: url,
...
$.AjaxCartUpdate = function (url, model) {
    $.ajax(
        {
            type: "post",
            url: url,
            ...
            success: function (result) {
                if (result.status == Status.Ok) {
                    ...
                    if (result.quantity == 0) {
                        ...
                        $("#cartCount").html('');
                        $("#cartCount").html(result.count);
                        $("#quantity-" + result.id).val(result.quantity);
                        $("#totalPrice-" + result.id).html(result.total + '₺');
                    }
...
$.AjaxCommentAdd = function (url, model) {
    $.ajax(
        {
            type: "post",
            url: url,
...
$.AjaxEditOrCreate = function (url, model) {
    $.ajax(
        {
            type: "post",
            url: url,
