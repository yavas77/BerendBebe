...
{
    public class ContactReplyDtoValidator:AbstractValidator<ContactReplyDto>
    {
        public ContactReplyDtoValidator()
        {
            RuleFor(x => x.Name)
               .NotEmpty()
               .WithMessage("Ad Soyad alanı boş geçilemez!")
               .MaximumLength(80)
               .WithMessage("Ad Soyad en fazla 80 karakter olabilir");
